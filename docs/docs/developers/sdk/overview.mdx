...
1. Visit the [Audius API Plans page](https://api.audius.co/plans) and click "Create API Key" to
...
do so. Keep your bearer token secure and never expose it in client-side code that could be
inspected.
...
For more details, visit the [API documentation](https://docs.audius.co/api) or the
[Swagger definition](https://api.audius.co/v1).
