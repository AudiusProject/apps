...
> #### createTrack(`params`, `advancedOptions?`)

Create and upload a track.
...
| `onProgress` | `(progress: number, event: `[`UploadTrackProgressEvent`](/developers/sdk/progress-events#uploadtrackprogressevent)` ) => void` | A function that will be called with progress events as the files upload | _Optional_   |
...
const { trackId } = await audiusSdk.tracks.createTrack({
  userId: '7eP5n',
  imageFile: {
...
| `trackId`         | `string`                                                                                                                      | The ID of the track                                                            | **Required** |
| `userId`          | `string`                                                                                                                      | The ID of the user                                                             | **Required** |
| `audioFile`       | `File`                                                                                                                        | A file that will be used to replace the audio for the track                    | _Optional_   |
| `imageFile`       | `File`                                                                                                                        | A file that will be used as the cover art for the track                        | _Optional_   |
