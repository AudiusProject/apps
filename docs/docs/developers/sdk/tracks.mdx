...
| `genre`                        | `string`                                                | Track genre (see [Genre Values](#genre-values))   | **Required** |
...
| `mood`                         | `string`                                                | Track mood (see [Mood Values](#mood-values))      | _Optional_   |
...
| :-------------------- | :-------------------------------------- | :------------------------------------------------ |
| `title`               | `string`                                | Track title                                       |
| `genre`               | `string`                                | Track genre (see [Genre Values](#genre-values))   |
| `description`         | `string`                                | Track description                                 |
| `mood`                | `string`                                | Track mood (see [Mood Values](#mood-values))      |
