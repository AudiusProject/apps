...
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/wallet-connect-button.png" />
...
{/* prettier-ignore */}
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/wallet-selector.png" />
...
{/* prettier-ignore */}
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/wallet-connected.png" />
...
{/* prettier-ignore */}
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/connect-profile-modal.png" />
...
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/authorize-app.png" />
...
{/* prettier-ignore */}
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/connect-audius-metamask.png" />
...
{/* prettier-ignore */}
<figure className="screensnippet-wrapper">
  <img src="/img/dashboard-account/audius-profile-linked.png" />
