...
const { albumId } = await audiusSdk.albums.uploadAlbum({
  userId: '7eP5n',
  imageFile: {
...
| Name             | Type                                                         | Description                                                                   | Required?    |
| :--------------- | :----------------------------------------------------------- | :---------------------------------------------------------------------------- | :----------- |
| `imageFile`      | `File`                                                       | A file that will be used as the cover art for the album                       | _Optional_   |
...
| `audioFiles`     | `Array<File>`                                                | An array of track audio files                                                 | **Required** |
...
| `albumId`    | `string`                     | The ID of the album                                                           | **Required** |
| `userId`     | `string`                     | The ID of the User                                                            | **Required** |
| `imageFile`  | `string`                     | A file that will be used as the cover art for the album                       | _Optional_   |
| `metadata`   | _see code sample below_      | An object containing the details of the album                                 | **Required** |
| `onProgress` | `(progress: number) => void` | A function that will be called with progress events as the image file uploads | _Optional_   |
