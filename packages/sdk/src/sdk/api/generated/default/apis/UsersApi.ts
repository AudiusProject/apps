...
export interface GetFavoriteTracksRequest {
    id: string;
    offset?: number;
    limit?: number;
    userId?: string;
    query?: string;
    sortMethod?: GetFavoriteTracksSortMethodEnum;
    sortDirection?: GetFavoriteTracksSortDirectionEnum;
}
...
export class UsersApi extends runtime.BaseAPI {
     ...
     * Creates a new user
     */
    async createUserRaw(params: CreateUserOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateUser201Response>> {
        if (params.createUserRequest === null || params.createUserRequest === undefined) {
            throw new runtime.RequiredError('createUserRequest','Required parameter params.createUserRequest was null or undefined when calling createUser.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateUserRequestToJSON(params.createUserRequest),
        }, initOverrides);
     ...
     * Creates a new user
     */
    async createUser(params: CreateUserOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateUser201Response> {
     ...
     * Follow a user
     */
    async followUserRaw(params: FollowUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Follow a user
     */
    async followUser(params: FollowUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     */
    async getFavoriteTracksRaw(params: GetFavoriteTracksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<TrackLibraryResponseFull>> {
        if (params.id === null || params.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter params.id was null or undefined when calling getFavoriteTracks.');
        }
     ...
     * Gets a user\'s favorite tracks
     */
    async getFavoriteTracks(params: GetFavoriteTracksRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TrackLibraryResponseFull> {
        const response = await this.getFavoriteTracksRaw(params, initOverrides);
        return await response.value();
    }
     ...
     * Mute a user
     */
    async muteUserRaw(params: MuteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Mute a user
     */
    async muteUser(params: MuteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     * Subscribe to a user
     */
    async subscribeToUserRaw(params: SubscribeToUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Subscribe to a user
     */
    async subscribeToUser(params: SubscribeToUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     * Unfollow a user
     */
    async unfollowUserRaw(params: UnfollowUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Unfollow a user
     */
    async unfollowUser(params: UnfollowUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     * Unmute a user
     */
    async unmuteUserRaw(params: UnmuteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Unmute a user
     */
    async unmuteUser(params: UnmuteUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     */
    async unsubscribeFromUserRaw(params: UnsubscribeFromUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
     ...
     * Unsubscribe from a user
     */
    async unsubscribeFromUser(params: UnsubscribeFromUserRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
     ...
     */
    async updateUserRaw(params: UpdateUserOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CreateComment201Response>> {
        if (params.id === null || params.id === undefined) {
            throw new runtime.RequiredError('id','Required parameter params.id was null or undefined when calling updateUser.');
        }

        if (params.updateUserRequest === null || params.updateUserRequest === undefined) {
            throw new runtime.RequiredError('updateUserRequest','Required parameter params.updateUserRequest was null or undefined when calling updateUser.');
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: UpdateUserRequestToJSON(params.updateUserRequest),
        }, initOverrides);
     ...
     * Updates an existing user profile
     */
    async updateUser(params: UpdateUserOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateComment201Response> {
 ...
 * @export
 */
export const GetFavoriteTracksSortMethodEnum = {
    Title: 'title',
    ArtistName: 'artist_name',
    ReleaseDate: 'release_date',
    LastListenDate: 'last_listen_date',
...
export type GetFavoriteTracksSortMethodEnum = typeof GetFavoriteTracksSortMethodEnum[keyof typeof GetFavoriteTracksSortMethodEnum];
/**
 * @export
 */
export const GetFavoriteTracksSortDirectionEnum = {
    Asc: 'asc',
    Desc: 'desc'
} as const;
export type GetFavoriteTracksSortDirectionEnum = typeof GetFavoriteTracksSortDirectionEnum[keyof typeof GetFavoriteTracksSortDirectionEnum];
/**
 * @export
 */
