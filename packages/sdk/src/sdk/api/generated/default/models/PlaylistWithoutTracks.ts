 ...
 * 
 * @export
 * @interface PlaylistWithoutTracks
 */
...
/**
 * Check if a given object implements the PlaylistWithoutTracks interface.
 */
export function instanceOfPlaylistWithoutTracks(value: object): value is PlaylistWithoutTracks {
    let isInstance = true;
...
export function PlaylistWithoutTracksFromJSON(json: any): PlaylistWithoutTracks {
    return PlaylistWithoutTracksFromJSONTyped(json, false);
}

export function PlaylistWithoutTracksFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlaylistWithoutTracks {
...
export function PlaylistWithoutTracksToJSON(value?: PlaylistWithoutTracks | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
